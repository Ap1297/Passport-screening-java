...
public class SanctionsServiceTest {
    ...
    public void testPanchalAnkitMukeshNameMatching() {
        ...
        sanctionedIndividual.setName("PANCHAL ANKIT MUKESH na Name (original): पंचाल अंकित");
        sanctionedIndividual.setCreatedDate(LocalDateTime.now());
        mockList.add(sanctionedIndividual);
        
        when(repository.findAll()).thenReturn(mockList);
        
        SanctionsService.ScreeningCheckResult result = sanctionsService.checkSanctions("PANCHALANKITMUKESH");
